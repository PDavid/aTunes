...
public class RemoveLovedSongInLastFMActionTest {

	@Test
	public void test() {
		RemoveLovedSongInLastFmAction sut = new RemoveLovedSongInLastFmAction();
		...
		verify(webServicesHandler).removeLovedSong(ao);
	}
}
