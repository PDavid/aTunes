...
public class SetPlayListSelectionAsFavoriteArtistActionTest {

	@Test
	public void test() {
		SetPlayListSelectionAsFavoriteArtistAction sut = new SetPlayListSelectionAsFavoriteArtistAction();
