...
public class XineEngine extends AbstractPlayerEngine {
	...
	if (audioObjectToPlay.getUrl() == null) {
	    ...
	    // Apply equalizer
	    applyEqualization(equalizer.isEnabled(),
		    equalizer.getEqualizerValues());
	...
	public void run() {
	    ...
	    xineController.setVolume(XineEngine.this.getStatePlayer()
		    .getVolume());
	}
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (s >= 0) {
		    ...
		    if (s < 1000) {
			uiHandler.updateTitleBar(audioObjectToPlay);
		    }
		}
	    }
	}
