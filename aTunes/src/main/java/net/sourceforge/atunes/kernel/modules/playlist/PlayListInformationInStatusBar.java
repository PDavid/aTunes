...
public class PlayListInformationInStatusBar {
     ...
     *            the play list
     */
    void showPlayListInformation(IPlayList playList) {
	 ...
	 * @return
	 */
	private String getToolTip(IPlayList playList, int audioFiles, int radios, int podcastFeedEntries, int audioObjects) {
