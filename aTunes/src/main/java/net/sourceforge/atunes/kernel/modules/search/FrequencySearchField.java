 ...
 * 
 */
public class FrequencySearchField extends IntegerSearchField<IAudioObject> {
	...
	public String getName() {
		return I18nUtils.getString("FREQUENCY");
	}
	...
	@Override
	public Integer getValueForEvaluation(IAudioObject audioObject) {
		return audioObject.getFrequency();
	}
}
