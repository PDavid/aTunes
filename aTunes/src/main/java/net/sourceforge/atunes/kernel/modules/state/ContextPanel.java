...
public final class ContextPanel extends AbstractPreferencesPanel {
	...
	private class LyricsEnginesTableModel implements TableModel {
		...
		public void setLyricsEnginesInfo(final List<ILyricsEngineInfo> lyricsEnginesInfo) {
	...
	private void arrangePanel(final JButton clearCache, final JLabel info,
			final JLabel enginesTableLabel, final JButton upButton, final JButton downButton,
			final JScrollPane enginesScrollPane) {
