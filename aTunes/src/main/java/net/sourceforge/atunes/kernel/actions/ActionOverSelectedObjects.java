...
public abstract class ActionOverSelectedObjects<T extends AudioObject> extends Action {
    ...
    public ActionOverSelectedObjects(String name, Class<T> objectsClass) {
        super(name);
        this.objectsClass = objectsClass;
    }

    public ActionOverSelectedObjects(String name, Icon icon, Class<T> objectsClass) {
        super(name, icon);
        this.objectsClass = objectsClass;
    }
