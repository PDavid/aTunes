...
public final class ImportPanel extends AbstractPreferencesPanel {
    ...
    /**
     * The radio button used to rename files when importing to a
     * custom name
     */
    ...
    /**
     * The radio button used to set folder when importing to a
     * custom pattern
     */
    ...
    public boolean applyPreferences() {
        ...
        stateRepository.setImportFileNamePattern(fileNamePattern == null || fileNamePattern.trim().equals("") ? null : fileNamePattern);
        String folderPathPattern = folderPathNoChangeRadioButton.isSelected() ? "" : folderPathPatternTextField.getText();
        stateRepository.setImportFolderPathPattern(folderPathPattern == null || folderPathPattern.equals("") ? null : folderPathPattern);
    ...
    public void updatePanel() {
        if (stateRepository.getImportFileNamePattern() == null || stateRepository.getImportFileNamePattern().trim().equals("")) {
            fileNameNoChangeRadioButton.setSelected(true);
            fileNamePatternTextField.setEnabled(false);
        } else {
            fileNameCustomizedRadioButton.setSelected(true);
            fileNamePatternTextField.setEnabled(true);
            fileNamePatternTextField.setText(stateRepository.getImportFileNamePattern());
        }
        if (stateRepository.getImportFolderPathPattern() == null || stateRepository.getImportFolderPathPattern().trim().equals("")) {
            folderPathNoChangeRadioButton.setSelected(true);
            folderPathPatternTextField.setEnabled(false);
        } else {
            folderPathCustomizedRadioButton.setSelected(true);
            folderPathPatternTextField.setEnabled(true);
            folderPathPatternTextField.setText(stateRepository.getImportFolderPathPattern());
        }
