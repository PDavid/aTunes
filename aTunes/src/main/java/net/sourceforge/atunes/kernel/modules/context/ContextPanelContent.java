...
/**
 * This class represents a little graphic component used in a context panel to show information about an audio object
 * Information shown is retrieved from a context data source
 * @author alex
 *
 */
public abstract class ContextPanelContent  {
	...
	/**
	 * Updates the context panel content with information of the given audio object
	 * @param audioObject
	 */
	...
	/**
	 * Removes content from the context panel content
	 * This method must clear all previous information retrieved for previous audio object
	 */
	...
	/**
	 * Given an audio object returns a map with necessary parameters to call data source
	 * @param audioObject
	...
	/**
	 * Returns a list of components to be shown in a popup button
	 * If this method returns <code>null</code> or empty list button will not be visible (default behaviour)
	 * @return
	 */
	...
	/**
	 * @param parentTaskPane the parentTaskPane to set
	 */
