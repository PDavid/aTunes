...
public class PlayListPodcastFeedEntryFilter implements IPlayListObjectFilter<PodcastFeedEntry> {
	
	@Override
	public List<PodcastFeedEntry> getObjects(IPlayList playList) {
