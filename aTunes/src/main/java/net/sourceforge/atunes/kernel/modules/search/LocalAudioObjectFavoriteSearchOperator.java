 ...
 * 
 */
public class LocalAudioObjectFavoriteSearchOperator implements
		ISearchUnaryOperator<ILocalAudioObject> {
	...
	@Override
	public boolean evaluate(ILocalAudioObject ao) {
		return this.favoritesHandler.isSongFavorite(ao);
	}
}
