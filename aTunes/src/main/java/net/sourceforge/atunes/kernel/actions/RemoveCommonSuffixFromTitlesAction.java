...
/**
 * Calls process to remove suffix from titles of a list of files
 * 
 * @author fleax
 * 
 */
public class RemoveCommonSuffixFromTitlesAction extends
	 ...
	 * Creates action
	 */
	public RemoveCommonSuffixFromTitlesAction() {
		super(I18nUtils.getString("REMOVE_COMMON_TITLE_SUFFIX"));
	}
	...
	protected void executeAction(final List<ILocalAudioObject> objects) {
		IChangeTagsProcess process = (IChangeTagsProcess) this.processFactory
				.getProcessByName("removeCommonSuffixProcess");
