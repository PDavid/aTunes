...
/**
 * This action calls sort play list by selected column forcing descending order
 * 
 * @author fleax
 * 
 */
public class SortPlayListColumnDescendingAction implements
		IColumnSetPopupAction {
	...
	public String getText() {
		return I18nUtils.getString("SORT_DESCENDING");
	}
}
