...
public abstract class AbstractCommonAudioFileSearchableObject implements ISearchableObject {
	...
	@Override
	public Document getDocumentForElement(final IAudioObject audioObject) {
		if (audioObject instanceof ILocalAudioObject) {
			...
			d.add(new Field(INDEX_FIELD_ARTIST, audioFile.getArtist(unknownObjectChecker), Field.Store.YES, Field.Index.ANALYZED));
			d.add(new Field(INDEX_FIELD_ALBUM_ARTIST, audioFile.getAlbumArtist(unknownObjectChecker), Field.Store.YES, Field.Index.ANALYZED));
			d.add(new Field(INDEX_FIELD_ALBUM, audioFile.getAlbum(unknownObjectChecker), Field.Store.YES, Field.Index.ANALYZED));
			...
			d.add(new Field(INDEX_FIELD_GENRE, audioFile.getGenre(unknownObjectChecker), Field.Store.YES, Field.Index.ANALYZED));
			 ...
			 */
			d.add(new Field(ISearchHandler.DEFAULT_INDEX, StringUtils.getString(audioFile.getTitle(), " ", audioFile.getTrackNumber(), " ", audioFile.getArtist(unknownObjectChecker), " ", audioFile
					.getAlbumArtist(unknownObjectChecker), " ", audioFile.getAlbum(unknownObjectChecker), " ", audioFile.getComposer(), " ", audioFile.getYear(), " ", audioFile.getGenre(unknownObjectChecker)), Field.Store.YES,
