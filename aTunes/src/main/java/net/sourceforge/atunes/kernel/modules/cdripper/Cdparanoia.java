...
public class Cdparanoia extends AbstractCdToWavConverter {
	 ...
	 */
	@Override
	public boolean cdda2wav(final int track, final File fileName, final boolean useParanoia) {
	 ...
	 * @throws IOException
	 */
	private int readCommandOutput(final BufferedReader stdInput, final int tracksNumber,
			final List<String> durations, final List<String> titles, final List<String> artists,
	...
	private void setCDInfo(final int tracks, final List<String> durations,
			final List<String> titles, final List<String> artists, final List<String> composers) {
	 ...
	 * @param s
	 */
	private void getAlbumInfo(final List<String> durations, final List<String> titles,
			final List<String> artists, final List<String> composers, final String s) {
