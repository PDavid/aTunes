...
public final class AutoCompleteDecorator {
     ...
     */
    public static void decorate(JTextComponent textComponent, List<Object> items, boolean strictMatching, ObjectToStringConverter stringConverter) {
    ...
    public static void decorate(JTextComponent textComponent, AutoCompleteDocument document, final AbstractAutoCompleteAdaptor adaptor) {
        ...
        if (document.isStrictMatching()) {
            ...
            editorActionMap.put("nonstrict-backspace", new NonStrictBackspaceAction(editorActionMap.get(DefaultEditorKit.deletePrevCharAction), editorActionMap
