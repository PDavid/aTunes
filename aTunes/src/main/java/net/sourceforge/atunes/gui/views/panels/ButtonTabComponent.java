...
public final class ButtonTabComponent extends JPanel {
    ...
    private final class TabButton extends JButton implements ActionListener {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.drawImage(Images.getImage(Images.CLOSE_TAB).getImage(), 0, 0, Images.getImage(Images.CLOSE_TAB).getIconWidth(), Images.getImage(Images.CLOSE_TAB).getIconHeight(),
                    null);
        }
